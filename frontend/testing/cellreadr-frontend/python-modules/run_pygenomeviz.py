...
output_dir = f"{os.getcwd()}/temp"
random_label = str(random.random()).replace('0.', '')
save_name = f"{output_dir}/{random_label}.png"

#with open("/root/Code/leptos_actix_5/temp/test.txt", "w") as file:
#    file.write(str(length_target))
#    file.write(str(vec_index_begin))
#    file.write(str(vec_index_end))
