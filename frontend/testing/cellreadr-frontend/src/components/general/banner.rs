            ...
            <div class="flex flex-wrap items-center justify-between mx-auto p-4">
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="/" class=assign_color_selected(current_page == "welcome".to_string())>Welcome</a>
                        </li>

                        <li>
                            <a href="/background" class=assign_color_selected(current_page == "background".to_string())>Background</a>
                        </li>

                        <li>
                            <a href="/protocols" class=assign_color_selected(current_page == "protocols".to_string())>Protocols</a>
                        </li>
